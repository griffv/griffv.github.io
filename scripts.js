...
{
 reset_alert_count();
 var compare_text=document.discordpost.content.value;
 ...
 {
  alert("It's nice week!\nThe following not nice words were found:\n_______________________________\n" + alert_text + "\n_______________________________");
  document.discordpost.content.select();
 }
 else
 {
  document.discordpost.submit();
  document.discordpost.content.value = "";
 }
}
